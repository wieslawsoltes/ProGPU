...
```bash
PROGPU_PACKAGE_VERSION=0.1.0-preview.53 ./eng/progpu-pack.sh
```
...
```bash
PROGPU_PACKAGE_VERSION=0.1.0-preview.53 ./eng/progpu-publish.sh
```
...
| --- | --- | --- |
| 12.0.5 | `ProGPU.Avalonia.Rendering` `12.0.5-preview.53` | `ProGPU.Avalonia.SilkNet` `12.0.5-preview.53` |
| 11.3.18 | `ProGPU.Avalonia.Rendering` `11.3.18-preview.53` | `ProGPU.Avalonia.SilkNet` `11.3.18-preview.53` |
...
```bash
dotnet add package ProGPU.Avalonia.Rendering --version 12.0.5-preview.53
dotnet add package ProGPU.Avalonia.SilkNet --version 12.0.5-preview.53
```

For Avalonia 11, use the same package IDs with `11.3.18-preview.53` and pin all
