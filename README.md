...
| --- | --- | --- |
| 12.1.1 | `ProGPU.Avalonia.Rendering` `12.1.1-preview.61` | `ProGPU.Avalonia.SilkNet` `12.1.1-preview.61` |
| 11.3.20 | `ProGPU.Avalonia.Rendering` `11.3.20-preview.61` | `ProGPU.Avalonia.SilkNet` `11.3.20-preview.61` |
...
```bash
dotnet add package ProGPU.Avalonia.Rendering --version 12.1.1-preview.61
dotnet add package ProGPU.Avalonia.SilkNet --version 12.1.1-preview.61
```

For Avalonia 11, use the same package IDs with `11.3.20-preview.61` and pin all
