...
| --- | --- | --- |
| 12.1.1 | `ProGPU.Avalonia.Rendering` `12.1.1-preview.60` | `ProGPU.Avalonia.SilkNet` `12.1.1-preview.60` |
| 11.3.20 | `ProGPU.Avalonia.Rendering` `11.3.20-preview.60` | `ProGPU.Avalonia.SilkNet` `11.3.20-preview.60` |
...
```bash
dotnet add package ProGPU.Avalonia.Rendering --version 12.1.1-preview.60
dotnet add package ProGPU.Avalonia.SilkNet --version 12.1.1-preview.60
```

For Avalonia 11, use the same package IDs with `11.3.20-preview.60` and pin all
