...
```bash
PROGPU_PACKAGE_VERSION=0.1.0-preview.51 ./eng/progpu-pack.sh
```
...
```bash
PROGPU_PACKAGE_VERSION=0.1.0-preview.51 ./eng/progpu-publish.sh
```
...
| --- | --- | --- |
| 12.0.5 | `ProGPU.Avalonia.Rendering` `12.0.5-preview.51` | `ProGPU.Avalonia.SilkNet` `12.0.5-preview.51` |
| 11.3.18 | `ProGPU.Avalonia.Rendering` `11.3.18-preview.51` | `ProGPU.Avalonia.SilkNet` `11.3.18-preview.51` |
...
```bash
dotnet add package ProGPU.Avalonia.Rendering --version 12.0.5-preview.51
dotnet add package ProGPU.Avalonia.SilkNet --version 12.0.5-preview.51
```

For Avalonia 11, use the same package IDs with `11.3.18-preview.51` and pin all
