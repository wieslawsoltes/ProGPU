...
| --- | --- | --- |
| 12.0.5 | `ProGPU.Avalonia.Rendering` `12.0.5-preview.29` | `ProGPU.Avalonia.SilkNet` `12.0.5-preview.29` |
| 11.3.18 | `ProGPU.Avalonia.Rendering` `11.3.18-preview.29` | `ProGPU.Avalonia.SilkNet` `11.3.18-preview.29` |
...
dotnet add package ProGPU.Avalonia.SilkNet --version 12.0.5-preview.29
```

For Avalonia 11, use the same package IDs with `11.3.18-preview.29` and pin all
