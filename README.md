...
| --- | --- | --- |
| 12.0.5 | `ProGPU.Avalonia.Rendering` `12.0.5-preview.54` | `ProGPU.Avalonia.SilkNet` `12.0.5-preview.54` |
| 11.3.18 | `ProGPU.Avalonia.Rendering` `11.3.18-preview.54` | `ProGPU.Avalonia.SilkNet` `11.3.18-preview.54` |
...
```bash
dotnet add package ProGPU.Avalonia.Rendering --version 12.0.5-preview.54
dotnet add package ProGPU.Avalonia.SilkNet --version 12.0.5-preview.54
```

For Avalonia 11, use the same package IDs with `11.3.18-preview.54` and pin all
