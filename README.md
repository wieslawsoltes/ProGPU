...
```bash
PROGPU_PACKAGE_VERSION=0.1.0-preview.30 ./eng/progpu-pack.sh
```
...
```bash
PROGPU_PACKAGE_VERSION=0.1.0-preview.30 ./eng/progpu-publish.sh
```
...
| --- | --- | --- |
| 12.0.5 | `ProGPU.Avalonia.Rendering` `12.0.5-preview.30` | `ProGPU.Avalonia.SilkNet` `12.0.5-preview.30` |
| 11.3.18 | `ProGPU.Avalonia.Rendering` `11.3.18-preview.30` | `ProGPU.Avalonia.SilkNet` `11.3.18-preview.30` |
...
```bash
dotnet add package ProGPU.Avalonia.Rendering --version 12.0.5-preview.30
dotnet add package ProGPU.Avalonia.SilkNet --version 12.0.5-preview.30
```

For Avalonia 11, use the same package IDs with `11.3.18-preview.30` and pin all
