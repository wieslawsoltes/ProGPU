...
| --- | --- | --- |
| 12.0.5 | `ProGPU.Avalonia.Rendering` `12.0.5-preview.31` | `ProGPU.Avalonia.SilkNet` `12.0.5-preview.31` |
| 11.3.18 | `ProGPU.Avalonia.Rendering` `11.3.18-preview.31` | `ProGPU.Avalonia.SilkNet` `11.3.18-preview.31` |
...
```bash
dotnet add package ProGPU.Avalonia.Rendering --version 12.0.5-preview.31
dotnet add package ProGPU.Avalonia.SilkNet --version 12.0.5-preview.31
```
