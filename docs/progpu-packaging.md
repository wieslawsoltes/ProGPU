...
| native ABI | `ProGPU.Backend.Native` `0.1.0-preview.48` | `ProGPU.Backend.Native` | Experimental typed C++ renderer host with Linux, macOS, and Windows x64/arm64 runtimes |
