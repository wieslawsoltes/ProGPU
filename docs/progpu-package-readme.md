...
Version `12.0.5-preview.29` is built against exactly Avalonia `12.0.5` and
ProGPU `0.1.0-preview.29` on .NET 10. Avalonia 11 applications use the same
package IDs at `11.3.18-preview.29`, built against exactly Avalonia `11.3.18`.
