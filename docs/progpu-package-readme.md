...
Version `12.0.5-preview.42` is built against exactly Avalonia `12.0.5` and
ProGPU `0.1.0-preview.42` on .NET 10. Avalonia 11 applications use the same
package IDs at `11.3.18-preview.42`, built against exactly Avalonia `11.3.18`.
...
PROGPU_INTEGRATION_PACKAGE_VERSION=11.3.18-preview.42 \
