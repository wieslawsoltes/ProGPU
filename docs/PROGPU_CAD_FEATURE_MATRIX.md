...
| SHX | regular, Unicode, Big Font, shapes, substitution | in progress | bounded immutable standard AutoCAD-86 parser, commands 0–14 analytic interpreter, thread-safe per-font glyph cache, standard control/placement layout, and pinned compiled-fixture regression implemented; snapshot/TEXT rendering, Unicode/Big Font contracts, resolver/substitution, conformance corpus, and fuzzing remain |
