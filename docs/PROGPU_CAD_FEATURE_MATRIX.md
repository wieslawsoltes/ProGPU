...
| 2D | all standard entities, blocks, XRefs, hatches, dimensions, images | in progress | line/circle/arc/ellipse/NURBS/lightweight and legacy 2D polyline/SOLID/3DFACE plus bounded nested static INSERT snapshot and top projection implemented; MINSERT/dynamic blocks/XRefs/attributes, remaining families, and multi-DPI/zoom image tests remain |
