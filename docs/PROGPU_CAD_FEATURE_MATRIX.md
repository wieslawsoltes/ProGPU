...
| SHX | regular, Unicode, Big Font, shapes, substitution | in progress | bounded immutable standard AutoCAD-86 compiled-container parser and pinned compiled-fixture regression implemented; opcode interpreter/rendering, Unicode/Big Font contracts, resolver/substitution, conformance corpus, and fuzzing remain |
