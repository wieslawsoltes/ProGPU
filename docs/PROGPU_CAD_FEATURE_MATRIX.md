...
| SHX | regular, Unicode, Big Font, shapes, substitution | in progress | bounded immutable standard AutoCAD-86 compiled-container parser plus commands 0–14 retained analytic interpreter and pinned compiled-fixture regression implemented; cached glyph/TEXT rendering, Unicode/Big Font contracts, resolver/substitution, conformance corpus, and fuzzing remain |
