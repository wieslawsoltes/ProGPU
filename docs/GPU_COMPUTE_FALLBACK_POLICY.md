...
of weakening parity. Microsoft Basic Render Driver now keeps automatic
GPU-first selection and partitions independent Canvas feature groups into
bounded native submissions with no intermediate readback or CPU composition.
All original pixels remain in the D3D12/Metal/Vulkan differential. The same
work uncovered and fixed full-target preservation for incremental isolated
layer commits; partitioned Metal retains the exact qualified
