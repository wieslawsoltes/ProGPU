...
color-glyph callback generation is implemented. `DrawText` still needs a typed
layout-factory seam and remains fail closed rather than activating a hidden
...
transform modes, `DrawText`, color-glyph translation, and
