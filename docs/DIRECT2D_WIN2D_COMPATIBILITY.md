...
can import. ABI v48 extends the deliberately ProGPU-owned COM endpoint from an
...
`ID2D1StrokeStyle1` metadata resources and compatible path-stroke recording.
