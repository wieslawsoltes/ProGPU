...
- Windows Media Foundation documents that
  ...
  DXGI/WebGPU; audible overlay audio is rejected when AAC output is requested
  until the native mixer lane is implemented.
