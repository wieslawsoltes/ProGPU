...
checking, 39 focused browser/sample contract tests, the complete 2,801-test
managed suite, and the package/documentation gate. A secure-context real
browser run with an application module remains required before making a
device-level latency, throughput, or audible-output claim.
