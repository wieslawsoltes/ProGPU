...
- Linux kernel
  ...
  assembly scan, or implicit codec lookup is used. This path is intentionally
  block-local: an effect may transform the supplied frames but no latency,
  look-ahead, or tail contract is currently modeled.
