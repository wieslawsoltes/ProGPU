...
public class DiagnosticsLoggingSourceTests
{
    ...
    public void WpfShimProjectsUseInRepoStrongNameKey()
    {
        ...
        Assert.Contains("<VersionSuffix Condition=\"'$(VersionSuffix)' == ''\">preview.60</VersionSuffix>", directoryBuildProps, StringComparison.Ordinal);
    ...
    public void EffectPipelineLayoutsUseStackBackedDescriptors()
    {
        ...
        AssertStackBackedLayout(mesh3D, 3, "GpuVertex3D", layoutCount: 2);
        ...
        static void AssertStackBackedLayout(
            string source,
            int attributeCount,
            string vertexType,
            int layoutCount = 1)
        {
            ...
            Assert.Contains($"Span<VertexBufferLayout> layouts = stackalloc VertexBufferLayout[{layoutCount}];", source, StringComparison.Ordinal);
