...
public class DiagnosticsLoggingSourceTests
{
    ...
    public void WpfShimProjectsUseInRepoStrongNameKey()
    {
        ...
        Assert.Contains("<VersionSuffix Condition=\"'$(VersionSuffix)' == ''\">preview.6</VersionSuffix>", directoryBuildProps, StringComparison.Ordinal);
    ...
    public void PathAtlasCleanupUsesPooledRemovalBuffers()
    {
        ...
        Assert.DoesNotContain("ArrayPool<byte>.Shared.Rent", pathAtlas, StringComparison.Ordinal);
