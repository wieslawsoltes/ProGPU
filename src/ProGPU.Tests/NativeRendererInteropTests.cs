...
public class NativeRendererInteropTests
{
    ...
    public void PrivateInteropRecordsMatchNativeAbiThree()
    {
        ...
        Assert.Equal(248, OffsetOf<NativeSceneMesh3D>(
            nameof(NativeSceneMesh3D.MaterialImageResourceIndex)));
        Assert.Equal(252, OffsetOf<NativeSceneMesh3D>(
            nameof(NativeSceneMesh3D.MaterialFactors)));
        Assert.Equal(256, OffsetOf<NativeSceneMesh3D>(
            nameof(NativeSceneMesh3D.LightOffset)));
        Assert.Equal(260, OffsetOf<NativeSceneMesh3D>(
            nameof(NativeSceneMesh3D.LightCount)));
    ...
    [Fact]
    public void SemanticSceneBuilderValidatesCanonicalRationalQuadraticSegments()
    {
        Assert.Equal(4U, (uint)NativePathSegmentKind.RationalQuadratic);
        ...
        Span<NativePathSegment> segments = stackalloc NativePathSegment[1]
        {
            new(
                ...
                new Vector2(6f, 12f),
                new Vector2(12f, 0f),
                pad0: BitConverter.SingleToUInt32Bits(0.5f))
        };
        ...
        segments[0] = new NativePathSegment(
            ...
            new Vector2(6f, 12f),
            new Vector2(12f, 0f),
            pad0: BitConverter.SingleToUInt32Bits(0f));
        builder = new NativeSceneStreamBuilder(
            destination,
            103U,
            1U,
        ...
        segments[0] = new NativePathSegment(
            ...
            new Vector2(6f, 12f),
            new Vector2(12f, 0f),
            pad0: BitConverter.SingleToUInt32Bits(float.MaxValue));
        builder = new NativeSceneStreamBuilder(
            destination,
            104U,
            1U,
