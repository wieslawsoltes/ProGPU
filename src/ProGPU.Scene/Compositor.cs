...
public struct GpuTextStyle
{
    [FieldOffset(0)] public Vector4 Color;
    [FieldOffset(16)] public uint TextRenderingMode;
...
internal struct MaskSamplingUniforms : IEquatable<MaskSamplingUniforms>
{
    [FieldOffset(0)] public Vector4 Coordinate0;
    [FieldOffset(16)] public Vector4 Coordinate1;
    [FieldOffset(32)] public Vector4 Bounds;
    [FieldOffset(48)] public Vector4 CornerRadiiX;
    [FieldOffset(64)] public Vector4 CornerRadiiY;
    [FieldOffset(80)] public Vector4 Options;

    public readonly bool Equals(MaskSamplingUniforms other) =>
        Coordinate0 == other.Coordinate0 &&
        Coordinate1 == other.Coordinate1 &&
        Bounds == other.Bounds &&
        CornerRadiiX == other.CornerRadiiX &&
        CornerRadiiY == other.CornerRadiiY &&
        Options == other.Options;

    public override readonly bool Equals(object? obj) =>
        obj is MaskSamplingUniforms other && Equals(other);
...
public struct CompositorMetrics
{
    ...
    public long RetainedCompositionTopologySynchronizations;
    public long RetainedCompositionAdornerSynchronizations;
    public long RetainedCompositionSceneUnchangedReuses;
    public long RetainedCompositionLayoutClipSynchronizations;
    public long RetainedCompositionGeometryClipSynchronizations;
    public long RetainedCompositionBitmapCacheSynchronizations;
    public long RetainedCompositionEffectSynchronizations;
    public long RetainedCompositionOpacityMaskSynchronizations;
    public long RetainedCompositionInheritedDrawingOptionsSynchronizations;
    public long RetainedCompositionComplexAppearanceSynchronizations;
    ...
    public long IncrementalSceneVectorVertexUploadBytes;
    public long IncrementalSceneVectorIndexUploadBytes;
    public long IncrementalSceneTextVertexUploadBytes;
    public long IncrementalSceneTextureVertexUploadBytes;
    public long IncrementalSceneTextureIndexUploadBytes;
    public long IncrementalSceneBrushUploadBytes;
    public long IncrementalSceneTextStyleUploadBytes;
    public long IncrementalSceneGradientStopUploadBytes;
    ...
    public uint PathAtlasAvoidedGrowthCount;
    ...
    public ulong TextStyleStorageBufferBytes;
    public ulong GradientStopStorageBufferBytes;
    public ulong EffectParameterBufferBytes;
    public uint PathRasterStagingBytes;
    public uint PathPeakRasterStagingBytes;
    public uint PathPeakRasterWidth;
    public uint PathPeakRasterHeight;
    ...
    public uint PathAtlasWidth;
    public uint PathAtlasHeight;
    public uint PathAtlasMaximumSize;
    public int GlyphOutlineCompiledCount;
    public int GlyphOutlineRecordCapacity;
    public int GlyphOutlineSegmentCount;
    public int GlyphOutlineSegmentCapacity;
    ...
    public int ActiveBrushCount;
    public int ActiveGradientStopCount;
    public int EffectShaderCount;
    public int EffectPipelineCount;
    public int SceneShaderCount;
    public int SceneRenderPipelineCount;
    public int SceneComputePipelineCount;
    public int BaseBindGroupLayoutCount;
    public int BasePipelineLayoutCount;
    public int BaseBindGroupCount;
    public int PersistentTextureBindGroupCount;
    public int MaskBindGroupCount;
    public int AnalyticMaskBindGroupCount;
    public int MaskRenderBindGroupCount;
    public int MaskTexturePoolCount;
    public int MaskTextureRetentionLimit;
    public int MaskTexturePeakDemand;
    public int AffineRectangleMaskPeakDemand;
    public int RoundedGeometryMaskPeakDemand;
    public int NonAxisAlignedCanonicalGeometryMaskPeakDemand;
    public int GeneralGeometryMaskPeakDemand;
    public int OpacityMaskPeakDemand;
    public float CanonicalGeometryMaskMinimumOffAxis;
    public float CanonicalGeometryMaskMaximumOffAxis;
...
public unsafe partial class Compositor : IDisposable
{
    ...
    {
        public static PathAtlasCapacityExceededException Instance { get; } = new();
    ...
    internal const int MaxBrushes = 8192;
    ...
    private RenderPipeline* _solidRoundedPipeline;
    ...
    private RenderPipeline* _solidRoundedPipelineOffscreen;
    private RenderPipeline* _textPipelineOffscreen;
    private RenderPipeline* _texturePipelineOffscreen;
    private readonly Dictionary<PipelineSelectionKey, nint> _selectedPipelines = new();
    private readonly Dictionary<RoundedRectanglePathKey, PathGeometry> _roundedRectanglePaths = new();
    private BindGroupLayout* _textureBindGroupLayout;
    private BindGroupLayout* _textureBindGroupLayoutOffscreen;

    private readonly record struct PipelineSelectionKey(
        DrawCallType Type,
        byte VectorKind,
        GpuBlendMode BlendMode,
        bool IsOffscreen,
        TextureFormat? OverrideFormat,
        GpuTextureAlphaMode TextureAlphaMode,
        bool HasMask);

    private readonly record struct RoundedRectanglePathKey(
        float X,
        float Y,
        float Width,
        float Height,
    ...
    private int _peakMaskTextureDemand;
    private int _currentFrameAffineRectangleMaskDemand;
    private int _currentFrameRoundedGeometryMaskDemand;
    private int _currentFrameNonAxisAlignedCanonicalGeometryMaskDemand;
    private int _currentFrameGeneralGeometryMaskDemand;
    private int _currentFrameOpacityMaskDemand;
    private bool _incrementalPagesBlockedByAnalyticMask;
    private int _peakAffineRectangleMaskDemand;
    private int _peakRoundedGeometryMaskDemand;
    private int _peakNonAxisAlignedCanonicalGeometryMaskDemand;
    private int _peakGeneralGeometryMaskDemand;
    private int _peakOpacityMaskDemand;
    private float _minimumCanonicalGeometryMaskOffAxis = float.PositiveInfinity;
    private float _maximumCanonicalGeometryMaskOffAxis;
    ...
    public struct CompositorDrawCall
    {
        ...
        public nint MaskBindGroupOverride;
    ...
    private int _legacyTextVertexCount;
    ...
    private GpuBuffer _brushesStorageBuffer;
    private GpuBuffer _textStylesStorageBuffer;
    ...
    private const int SolidRoundedSpecializationThreshold = 32;
    private int _previousSolidRoundedPrimitiveCount;
    private int _currentSolidRoundedPrimitiveCount;
    ...
    internal GpuBuffer TextStylesStorageBuffer => _textStylesStorageBuffer;
    ...
    public ulong PersistentSceneBufferBytes =>
        ...
        _textVertexBuffer.AllocatedSize +
        _textureVertexBuffer.AllocatedSize +
        _textureIndexBuffer.AllocatedSize;
    ...
    public Compositor(WgpuContext context, TextureFormat? renderFormat, CompositorOptions options)
    {
        ...
        _atlas = new GlyphAtlas(
            ...
            Math.Min(options.InitialGlyphAtlasSize, options.GlyphAtlasSize),
            options.ColorGlyphAtlasSize,
            Math.Min(options.InitialColorGlyphAtlasSize, options.ColorGlyphAtlasSize),
            options.GlyphUniformStagingBytes,
        ...
        _textStylesStorageBuffer = new GpuBuffer(
            _context,
            options.InitialTextStyleCount *
                (uint)Marshal.SizeOf<GpuTextStyle>(),
            BufferUsage.Storage | BufferUsage.CopyDst,
            "Compositor Text Styles Storage Buffer"
        );
    ...
    private void InitializePipelinesAndBindGroups()
    {
        ...
        if (Options.PrecompileBasePipelines)
        {
            var vecShaderModule = _pipelineCache.GetOrCreateShader(
                "Vector",
                Shaders.VectorShader,
                "VectorShader");
            var textShaderModule = _pipelineCache.GetOrCreateShader(
                "Text",
                Shaders.TextShader,
                "TextShader");
            var texShaderModule = _pipelineCache.GetOrCreateShader(
                "Texture",
            ...
            fixed (VertexAttribute* attribsPtr = vectorAttrs)
            {
                ...
                // Explicit prewarming policy for clients that prefer startup compilation.
        ...
        RecreateVectorUniformBindGroups();
    ...
    private void RecreateVectorUniformBindGroups()
    {
        var vectorEntries = stackalloc BindGroupEntry[3];
        vectorEntries[0] = new BindGroupEntry
        {
            Binding = 0,
            Buffer = _uniformBuffer.BufferPtr,
            Offset = 0,
        ...
        vectorEntries[1] = new BindGroupEntry
        {
            Binding = 1,
        ...
        vectorEntries[2] = new BindGroupEntry
        {
            Binding = 2,
        ...
        BindGroup* vectorReplacement =
            _context.Api.DeviceCreateBindGroup(
                _context.Device,
                &vectorDescriptor);
        var textEntries = stackalloc BindGroupEntry[3];
        textEntries[0] = vectorEntries[0];
        textEntries[1] = new BindGroupEntry
        {
            Binding = 1,
            Buffer = _textStylesStorageBuffer.BufferPtr,
            Offset = 0,
            Size = _textStylesStorageBuffer.Size
        };
        textEntries[2] = vectorEntries[2];
        ...
        BindGroup* textReplacement =
            _context.Api.DeviceCreateBindGroup(
                _context.Device,
                &textDescriptor);

        if (vectorReplacement == null || textReplacement == null)
        {
            if (vectorReplacement != null)
                _context.Api.BindGroupRelease(vectorReplacement);
            if (textReplacement != null)
                _context.Api.BindGroupRelease(textReplacement);
            throw new InvalidOperationException(
                "Failed to create compositor scene-state bind groups.");
        }

        BindGroup* previous = _vectorUniformBindGroup;
        BindGroup* previousOffscreen = _vectorUniformBindGroupOffscreen;
        BindGroup* previousText = _textUniformBindGroup;
        BindGroup* previousTextOffscreen =
            _textUniformBindGroupOffscreen;
        _vectorUniformBindGroup = vectorReplacement;
        _vectorUniformBindGroupOffscreen = vectorReplacement;
        _textUniformBindGroup = textReplacement;
        _textUniformBindGroupOffscreen = textReplacement;
        if (previous != null)
        {
            _context.QueueBindGroupDisposal((nint)previous);
        }
        if (previousOffscreen != null && previousOffscreen != previous)
        {
            _context.QueueBindGroupDisposal((nint)previousOffscreen);
        }
        if (previousText != null)
        {
            _context.QueueBindGroupDisposal((nint)previousText);
        }
        if (previousTextOffscreen != null &&
            previousTextOffscreen != previousText)
        {
            _context.QueueBindGroupDisposal(
                (nint)previousTextOffscreen);
        }
    }
    ...
    private void RefreshAtlasBindGroupsIfNeeded()
    {
        if (_boundGlyphAtlasTextureRevision != _atlas.TextureRevision)
        {
            ...
            if (_atlasBindGroupOffscreen != null && _atlasBindGroupOffscreen != _atlasBindGroup)
            {
    ...
    private void RenderSceneCore(Visual root, uint width, uint height, TextureView* targetView)
    {
        ...
        ResetMaskClassificationFrameMetrics();
...
SceneCompilationComplete:
        if (!reuseCompiledScene)
        {
            ...
            _previousSolidRoundedPrimitiveCount = _currentSolidRoundedPrimitiveCount;
        }
        if (glyphBatchActive)
        {
...
DynamicBufferUploadComplete:
        ...
        if (_activeTextStyles.Count > 0)
        {
            UploadIncrementalSceneBuffer(
                _textStylesStorageBuffer,
                CollectionsMarshal.AsSpan(_activeTextStyles),
                ref _textStyleUploadShadow);
        }
        ...
        CaptureCompiledScene(
            ...
            activeToolTip,
            hasDynamicDiagnostics);
        if (requiresSolidRoundedSpecializationRecompile)
        {
            _compiledSceneReusable = false;
            _compiledSceneCacheStateReason = "Solid rounded specialization changed";
        }
...
SceneStateUploadComplete:
        ...
        for (var drawCallIndex = 0; drawCallIndex < drawCallCount; drawCallIndex++)
        {
            ...
            if (dc.Type == DrawCallType.Vector)
            {
                ...
                if (currentType != DrawCallType.Vector ||
                    ...
                    currentVectorPipelineKind != vectorPipelineKind)
                {
                    ...
                    currentBlendMode = dc.BlendMode;
                    currentMaskBindGroup = maskBindGroup;
                    currentPipelineHasMask = hasMask;
                    currentVectorPipelineKind = vectorPipelineKind;
                }
                else if (currentMaskBindGroup != maskBindGroup)
                {
                    _context.Api.RenderPassEncoderSetBindGroup(pass, 2, maskBindGroup, 0, null);
                    currentMaskBindGroup = maskBindGroup;
                }
            ...
            else if (dc.Type == DrawCallType.Texture && IsTextureBindable(dc.Texture))
            {
                ...
                if (currentMaskBindGroup != maskBindGroup || currentType != DrawCallType.Texture || currentBlendMode != dc.BlendMode)
                {
                    _context.Api.RenderPassEncoderSetBindGroup(pass, 2, maskBindGroup, 0, null);
                    currentMaskBindGroup = maskBindGroup;
                }
            ...
            else if (dc.Type == DrawCallType.Extension)
            {
                ...
                if (pipeline != null)
                {
                    if (pipeline is ProGPU.Scene.Extensions.SplineExtensionPipeline)
                    {
                        ...
                        if (selectedVectorPipeline || currentMaskBindGroup != maskBindGroup)
                        {
                            _context.Api.RenderPassEncoderSetBindGroup(pass, 2, maskBindGroup, 0, null);
                            currentMaskBindGroup = maskBindGroup;
                        }
            ...
            _wavefrontTextureBindGroup != null)
        {
            ...
            var finalPipeline = GetPipeline(
                DrawCallType.Texture,
                GpuBlendMode.SrcOver,
                isOffscreen: true,
                hasMask: false);
            _context.Api.RenderPassEncoderSetPipeline(finalPass, finalPipeline);
        ...
        Metrics = new CompositorMetrics
        {
            ...
            GlyphUniformStagingBytes = _atlas.UniformStagingBytes,
            GlyphUniformUploadBytes = _atlas.UniformUploadBytes,
            ...
            PathAtlasAvoidedGrowthCount = _pathAtlas.AtlasAvoidedGrowthCount,
            ...
            TextStyleStorageBufferBytes =
                _textStylesStorageBuffer.AllocatedSize,
            GradientStopStorageBufferBytes = _gradientStopsStorageBuffer.AllocatedSize,
            EffectParameterBufferBytes = _compute.PersistentEffectParameterBufferBytes,
            PathRasterStagingBytes = _pathAtlas.LastRasterStagingBytes,
            PathPeakRasterStagingBytes = _pathAtlas.PeakRasterStagingBytes,
            PathPeakRasterWidth = _pathAtlas.PeakRasterWidth,
            PathPeakRasterHeight = _pathAtlas.PeakRasterHeight,
            ...
            PathAtlasWidth = _pathAtlas.AtlasWidth,
            PathAtlasHeight = _pathAtlas.AtlasHeight,
            ...
            GlyphOutlineSegmentCount = _atlas.CompiledGpuSegmentCount,
            GlyphOutlineSegmentCapacity = _atlas.AllocatedGpuSegmentCapacity,
            ...
            ActiveBrushCount = _activeBrushes.Count,
            ActiveGradientStopCount = _activeGradientStops.Count,
            EffectShaderCount = _compute.CachedEffectShaderCount,
            EffectPipelineCount = _compute.CachedEffectPipelineCount,
            SceneShaderCount = _pipelineCache.ShaderCount,
            SceneRenderPipelineCount = _pipelineCache.RenderPipelineCount,
            SceneComputePipelineCount = _pipelineCache.ComputePipelineCount,
            BaseBindGroupLayoutCount = 8,
            BasePipelineLayoutCount = 4,
            ...
            MaskTexturePeakDemand = _peakMaskTextureDemand,
            AffineRectangleMaskPeakDemand =
                _peakAffineRectangleMaskDemand,
            RoundedGeometryMaskPeakDemand = _peakRoundedGeometryMaskDemand,
            NonAxisAlignedCanonicalGeometryMaskPeakDemand =
                _peakNonAxisAlignedCanonicalGeometryMaskDemand,
            GeneralGeometryMaskPeakDemand = _peakGeneralGeometryMaskDemand,
            OpacityMaskPeakDemand = _peakOpacityMaskDemand,
            CanonicalGeometryMaskMinimumOffAxis =
                float.IsFinite(_minimumCanonicalGeometryMaskOffAxis)
                    ? _minimumCanonicalGeometryMaskOffAxis
                    : 0f,
            CanonicalGeometryMaskMaximumOffAxis =
                _maximumCanonicalGeometryMaskOffAxis,
            ...
            IncrementalSceneVectorVertexUploadBytes =
                _incrementalSceneVectorVertexUploadBytes,
            IncrementalSceneVectorIndexUploadBytes =
                _incrementalSceneVectorIndexUploadBytes,
            IncrementalSceneTextVertexUploadBytes =
                _incrementalSceneTextVertexUploadBytes,
            IncrementalSceneTextureVertexUploadBytes =
                _incrementalSceneTextureVertexUploadBytes,
            IncrementalSceneTextureIndexUploadBytes =
                _incrementalSceneTextureIndexUploadBytes,
            IncrementalSceneBrushUploadBytes =
                _incrementalSceneBrushUploadBytes,
            IncrementalSceneTextStyleUploadBytes =
                _incrementalSceneTextStyleUploadBytes,
            IncrementalSceneGradientStopUploadBytes =
                _incrementalSceneGradientStopUploadBytes,
    ...
    private bool IsAttachedToAnyActiveRoot(Visual fe, Visual mainRoot, IReadOnlyList<Visual>? externalLayers, Visual? activeToolTip)
    {
        ...
        while (node != null)
        {
            ...
            for (int i = 0; i < _embeddedVisualsInFrame.Count; i++)
            {
                if (node == _embeddedVisualsInFrame[i].Visual)
                    return true;
            }
        ...
        if (!IsAxisAlignedClipTransform(transform))
        {
            PathGeometry geometry =
                PrimitivePathGeometry.CreateRectangle(
                    ...
                    localClip.Width,
                    localClip.Height);
            RecordGeometryMaskKind(geometry, transform);
            if (!TryPushAnalyticCanonicalGeometryMask(
                    geometry,
                    transform))
            {
    ...
    private void ReturnPendingMaskTexturesToPool()
    {
        ...
        ReturnAnalyticMaskResourcesToPool();
        ReturnMaskRenderPassDrawCallLists();
    }

    private void TrimMaskTexturePool(int currentDemand)
    {
        _peakMaskTextureDemand = Math.Max(_peakMaskTextureDemand, currentDemand);
        ...
        bool includeLocalVisualState)
    {
             ...
             ownedRenderCommandCache.HasRenderCommands))
        {
            ...
            try
            {
                ...
                var commandCount = ownsRenderCommandCache
                    ? ownedRenderCommandCache!.RenderCommandCount
                    : commands.Count;
                bool captureIncrementalPage =
                    TryBeginIncrementalScenePage(
                        node,
                        commands,
                        ownedRenderCommandCache,
                        out IncrementalScenePageBoundary incrementalPageBoundary);
                for (var commandIndex = 0; commandIndex < commandCount; commandIndex++)
                {
                    RenderCommand command = ownsRenderCommandCache
                        ? ownedRenderCommandCache!.GetRenderCommand(commandIndex)
        ...
        Matrix4x4 transform)
    {
        ...
        if (!hasInner && !hasRoundedCorners)
        {
            if (_offscreenRenderDepth != 0)
            {
                // Picture/layer textures must retain the coverage raster that
                // is subsequently filtered at composition time.
                return false;
            }

            // A sharp canonical rectangle is exactly representable by the
            // existing one-quad rectangle shader on the final target. Retain
            // coverage-atlas rasterization for offscreen recorded paths:
            // materializing the SDF edge before a later texture filter changes
            // the two-stage coverage convolution and no longer matches Skia
            ...
            rectangleCommand.Rect = new Rect(
                ...
                outer.Width,
                outer.Height);
            CompileRectCommand(rectangleCommand, transform);
            return true;
        }
        ...
        // chord error, then emit a balanced convex triangulation or an
        // outer/inner triangle band. Each triangle uses the existing analytic
        // edge-distance shader with deterministic ownership for shared edges,
        // so page-sized geometry does not reserve or rasterize a PathAtlas tile.
        // Time and temporary space are O(C), where C is the bounded contour size.
        ...
        out Vector2 max)
    {
        ...
        if (!ArcSegmentGeometry.TryCreateShaderParameters(
            ...
            !ArcSegmentGeometry.TryGetArcBounds(parameters, out min, out max))
        {
            return false;
        }
    ...
    private static bool TrySelectDirection(out Vector2 direction, Vector2 candidate)
    {
        if (TryUseDirection(candidate, out direction))
        {
            return true;
        }
    ...
    private static bool TrySelectDirection(
        out Vector2 direction,
        Vector2 first,
        Vector2 second)
    {
        if (TryUseDirection(first, out direction) ||
            TryUseDirection(second, out direction))
        {
            return true;
        }
        ...
        Vector2 third)
    {
        if (TryUseDirection(first, out direction) ||
            TryUseDirection(second, out direction) ||
            TryUseDirection(third, out direction))
        {
            return true;
        }
    ...
    private static bool TryUseDirection(Vector2 candidate, out Vector2 direction)
    {
    ...
    private void CompileDotGridCommand(RenderCommand cmd, Matrix4x4 transform)
    {
        ...
        var shapeType = EncodeShapeType(cmd, DotGridShapeType);
        var baseVertex = (uint)_vectorVerticesList.Count;

        var vertexStart = _vectorVerticesList.Count;
        CollectionsMarshal.SetCount(_vectorVerticesList, vertexStart + 4);
        var vertices = CollectionsMarshal.AsSpan(_vectorVerticesList).Slice(vertexStart, 4);
    ...
    private void CompileRoundedRectCommand(RenderCommand cmd, Matrix4x4 transform)
    {
        ...
        bool useSolidRoundedPipeline = isSolidRoundedCandidate &&
            _previousSolidRoundedPrimitiveCount >= SolidRoundedSpecializationThreshold;
        SwitchBatch(useSolidRoundedPipeline ? BatchType.SolidRounded : BatchType.Vector);
        int startIndex = _vectorVerticesList.Count;
        var radius = radiusX;
        float wHalf = r.Width / 2f;
        float hHalf = r.Height / 2f;
        ...
        if (cmd.Brush != null)
        {
            ...
            float bIdx = useSolidRoundedPipeline ? 0f : RegisterBrush(cmd.Brush);
            var solidColor = (cmd.Brush is SolidColorBrush solid) ? solid.Color : new Vector4(r.X + wHalf, r.Y + hHalf, 0f, 0f);
    ...
    private PathGeometry GetOrCreateRoundedRectanglePath(Rect rect, float radiusX, float radiusY)
    {
        var key = new RoundedRectanglePathKey(
            rect.X,
            rect.Y,
            rect.Width,
            rect.Height,
            radiusX,
            radiusY);
        if (_roundedRectanglePaths.TryGetValue(key, out var path))
        {
            return path;
        }

        if (_roundedRectanglePaths.Count >= MaximumRoundedRectanglePathCacheEntries)
        {
            _roundedRectanglePaths.Clear();
        }

        path = PrimitivePathGeometry.CreateRoundedRectangle(
            rect.X,
            rect.Y,
            rect.Width,
            rect.Height,
            radiusX,
            radiusY);
        _roundedRectanglePaths[key] = path;
        return path;
    }
        ...
        TextRenderingMode textRenderingMode)
    {
        ...
        Vector4 color = solid?.Color ?? Vector4.One;
        color.W *= (brush?.Opacity ?? 1f) * _activeOpacity;
        _activeTextStyles.Add(new GpuTextStyle
        {
            Color = color,
            TextRenderingMode = (uint)textRenderingMode
        });
        return _activeTextStyles.Count - 1;
    }
    ...
    private void CompileTextCommand(RenderCommand cmd, ITextLayoutProvider? textNode, Matrix4x4 transform)
    {
        ...
        bool usesGpuTextStyle =
            ActiveCompilationContext == null &&
            (cmd.Brush == null || cmd.Brush is SolidColorBrush);
        float bIdx = usesGpuTextStyle
            ? RegisterTextStyle(
                cmd.Brush,
        ...
        effectiveColor.W *=
            (cmd.Brush?.Opacity ?? 1f) * _activeOpacity;
        ...
        for (int glyphIndex = 0; glyphIndex < layoutGlyphCount; glyphIndex++)
        {
            ...
            for (int pass = 0; pass < passCount; pass++)
            {
                ...
                _textVerticesList.Add(new GlyphInstance
                {
                    ...
                    Color = usesGpuTextStyle ? color : effectiveColor,
    ...
    {
        CommitPendingVectorDrawCall(isSolidRect: false, isSolidRounded: false);
    }

    private void CommitPendingSolidRectDrawCall()
    {
        CommitPendingVectorDrawCall(isSolidRect: true, isSolidRounded: false);
    }

    private void CommitPendingSolidRoundedDrawCall()
    {
        CommitPendingVectorDrawCall(isSolidRect: false, isSolidRounded: true);
    }

    private void CommitPendingVectorDrawCall(bool isSolidRect, bool isSolidRounded)
    {
    ...
    private void SwitchBatch(BatchType nextType)
    {
        ...
        else if (_currentBatchType == BatchType.SolidRounded)
        {
            CommitPendingSolidRoundedDrawCall();
        }
    ...
    private void EnsureSceneStateBufferCapacity()
    {
        ...
        if (vectorStateResized || textStateResized)
        {
            // A WebGPU bind group captures a concrete buffer and exposed range.
            // Growing any scene-state buffer therefore requires replacement
            // bind groups before the next pass.
            InvalidateMaskRenderTextSceneStateBindGroups();
            RecreateVectorUniformBindGroups();
        }
    }

    private void InvalidateMaskRenderTextSceneStateBindGroups()
    {
        foreach (MaskRenderResource resource in
                 _maskRenderResources.Values)
        {
            if (resource.TextUniformBindGroupPtr == 0)
                continue;

            QueueBindGroupRelease(
                resource.TextUniformBindGroupPtr);
            resource.TextUniformBindGroupPtr = 0;
        }
    }
    ...
    private CommandEncoder* CreateCommandEncoder(ReadOnlySpan<byte> label)
    {
        ...
        {
            var descriptor = new CommandEncoderDescriptor { Label = labelPointer };
            return _context.Api.DeviceCreateCommandEncoder(_context.Device, &descriptor);
        }
    }

    private CommandBuffer* FinishCommandEncoder(
        CommandEncoder* encoder,
        ReadOnlySpan<byte> label)
    {
        fixed (byte* labelPointer = label)
        {
            var descriptor = new CommandBufferDescriptor { Label = labelPointer };
            return _context.Api.CommandEncoderFinish(encoder, &descriptor);
        }
    }
        ...
        uint renderHeight)
    {
        ...
        if (_wavefrontTextureBindGroup == null ||
            _wavefrontTextureBindGroupGeneration != _wavefrontColorTexture.ViewGeneration)
        {
            if (_wavefrontTextureBindGroup != null)
            {
                QueueBindGroupRelease((nint)_wavefrontTextureBindGroup);
        ...
        lock (_context.RenderLock)
        {
            ...
            if (!_context.IsDisposed)
            {
                ...
                if (_vectorUniformBindGroupOffscreen != null &&
                    _vectorUniformBindGroupOffscreen != _vectorUniformBindGroup)
                    _context.QueueBindGroupDisposal((IntPtr)_vectorUniformBindGroupOffscreen);
                if (_textUniformBindGroup != null) _context.QueueBindGroupDisposal((IntPtr)_textUniformBindGroup);
                if (_textUniformBindGroupOffscreen != null &&
                    _textUniformBindGroupOffscreen != _textUniformBindGroup)
                    _context.QueueBindGroupDisposal((IntPtr)_textUniformBindGroupOffscreen);
                if (_textureUniformBindGroup != null) _context.QueueBindGroupDisposal((IntPtr)_textureUniformBindGroup);
                if (_textureUniformBindGroupOffscreen != null &&
                    _textureUniformBindGroupOffscreen != _textureUniformBindGroup)
            ...
            for (int index = 0;
                 index < _analyticMaskResourcePool.Count;
                 index++)
            {
                DisposeMaskBindGroupResource(
                    _analyticMaskResourcePool[index]);
            }
            _analyticMaskResourcePool.Clear();
            for (int index = 0;
                 index < _analyticMasksToReturnToPool.Count;
                 index++)
            {
                DisposeMaskBindGroupResource(
        ...
        AdvancedBlendPassResource passResource)
    {
        ...
        try
        {
            ...
            var maskBindGroup = GetDrawCallMaskBindGroup(
                drawCall,
                isOffscreen: true);
        ...
        bool includeRootVisualState)
    {
        ...
        Metrics = new CompositorMetrics
        {
            FrameTimeMs = System.Diagnostics.Stopwatch
                .GetElapsedTime(totalStartTimestamp, renderEndTimestamp).TotalMilliseconds,
            VisualTreeCompileTimeMs = System.Diagnostics.Stopwatch
                .GetElapsedTime(totalStartTimestamp, compileEndTimestamp).TotalMilliseconds,
            GpuUploadTimeMs = System.Diagnostics.Stopwatch
        ...
        GpuBlendMode blendMode = GpuBlendMode.SrcOver)
    {
        ...
        var maskBg = maskBindGroupOverride != 0
            ? (BindGroup*)maskBindGroupOverride
            : GetMaskBindGroup(maskTexture, isOffscreen);
        bool hasMask =
            maskTexture != null ||
            maskBindGroupOverride != 0;
            ...
            else if (dc.Type == DrawCallType.Extension)
            {
                ...
                if (pipeline != null)
                {
                    if (pipeline is ProGPU.Scene.Extensions.SplineExtensionPipeline)
                    {
                        if (currentType != DrawCallType.Vector)
                        {
                            var vectorPipeline = GetPipeline(
                                DrawCallType.Vector,
                                blendMode,
                                isOffscreen,
                                hasMask: hasMask);
    ...
    private unsafe void EnsureChartLinePipelines()
    {
        if (_chartLinePipeline != null &&
            _chartLinePipelineOffscreen != null &&
            _chartLineBindGroupLayout != null)
        {
            return;
        }
        ...
        ShaderModule* shader = _pipelineCache.GetOrCreateShader(
            "ChartLine",
            Shaders.ChartLineShader,
            "ChartLineShader");
        RenderPipeline* pipeline = _pipelineCache.GetOrCreateRenderPipeline(
            "ChartLine",
            shader,
            "vs_main",
            "fs_main",
            ...
            enableBlend: true,
            sampleCount: Options.PrimarySampleCount);
        RenderPipeline* offscreenPipeline = _pipelineCache.GetOrCreateRenderPipeline(
            "ChartLine_Offscreen",
            shader,
            "vs_main",
            "fs_main",
        ...
        BindGroupLayout* bindGroupLayout =
            _context.Api.RenderPipelineGetBindGroupLayout(pipeline, 0);
        if (pipeline == null || offscreenPipeline == null || bindGroupLayout == null)
        {
            if (bindGroupLayout != null)
            {
                _context.QueueBindGroupLayoutDisposal((nint)bindGroupLayout);
            }

            throw new InvalidOperationException("Failed to create chart-line pipelines.");
        }

        _chartLinePipeline = pipeline;
        _chartLinePipelineOffscreen = offscreenPipeline;
        _chartLineBindGroupLayout = bindGroupLayout;
    }

    private unsafe void EnsureChartScatterPipelines()
    {
        if (_chartScatterPipeline != null &&
            _chartScatterPipelineOffscreen != null &&
            _chartScatterBindGroupLayout != null)
        {
            return;
        }
        ...
        ShaderModule* shader = _pipelineCache.GetOrCreateShader(
            "ChartScatter",
            Shaders.ChartScatterShader,
            "ChartScatterShader");
        Span<VertexAttribute> scatterAttrs = stackalloc VertexAttribute[2];
        scatterAttrs[0] = new VertexAttribute
        {
            Format = VertexFormat.Float32x2,
            Offset = 0,
            ShaderLocation = 0
        };
        scatterAttrs[1] = new VertexAttribute
        {
        ...
        fixed (VertexAttribute* scatterAttribsPtr = scatterAttrs)
        {
            ...
            if (pipeline == null || offscreenPipeline == null || bindGroupLayout == null)
            {
                ...
                throw new InvalidOperationException("Failed to create chart-scatter pipelines.");
            }

            _chartScatterPipeline = pipeline;
            _chartScatterPipelineOffscreen = offscreenPipeline;
            _chartScatterBindGroupLayout = bindGroupLayout;
        }
    }
    ...
    private struct MaskRenderPassInfo
    {
        ...
        public nint PreviousMaskBindGroupOverride;
    ...
    private readonly record struct MaskTextureState(
        GpuTexture? Texture,
        MaskPixelBounds Bounds,
        MaskBindGroupResource? AnalyticResource);
    ...
    internal static bool HasMask(in CompositorDrawCall drawCall) =>
        drawCall.MaskTexture != null ||
        drawCall.MaskBindGroupOverride != 0;

    internal BindGroup* GetDrawCallMaskBindGroup(
        in CompositorDrawCall drawCall,
        bool isOffscreen) =>
        drawCall.MaskBindGroupOverride != 0
            ? (BindGroup*)drawCall.MaskBindGroupOverride
            : GetMaskBindGroup(
                drawCall.MaskTexture,
                isOffscreen);

    private MaskBindGroupResource RentAnalyticMaskResource(
        MaskSamplingUniforms samplingUniforms)
    {
        int lastIndex = _analyticMaskResourcePool.Count - 1;
        if (lastIndex >= 0)
        {
            MaskBindGroupResource resource =
                _analyticMaskResourcePool[lastIndex];
            _analyticMaskResourcePool.RemoveAt(lastIndex);
        ...
        var samplingBuffer = new GpuBuffer(
            ...
            (uint)Marshal.SizeOf<MaskSamplingUniforms>(),
            BufferUsage.Uniform | BufferUsage.CopyDst,
            "Analytic Mask Sampling Uniform Buffer");
        samplingBuffer.WriteSingle(samplingUniforms);
        ...
        {
            Binding = 1,
            TextureView = _dummyMaskTexture!.ViewPtr
        };
        entries[2] = new BindGroupEntry
        {
            Binding = 2,
        ...
        BindGroup* bindGroup = _context.Api.DeviceCreateBindGroup(
            _context.Device,
            &descriptor);
        if (bindGroup == null)
        {
            samplingBuffer.Dispose();
            throw new InvalidOperationException(
                "Failed to create analytic mask bind group.");
        }

        return new MaskBindGroupResource
        {
            SamplingBuffer = samplingBuffer,
    ...
    private void ReturnAnalyticMaskResourcesToPool()
    {
        if (_analyticMasksToReturnToPool.Count == 0)
        {
            return;
        }
        ...
        int retentionLimit = Math.Min(
            Options.MaximumPooledMaskTextures,
            Math.Max(2, _maskTextureRetentionLimit));
        int excess =
            _analyticMaskResourcePool.Count - retentionLimit;
        for (int index = 0; index < excess; index++)
        {
            MaskBindGroupResource resource =
                _analyticMaskResourcePool[0];
            _analyticMaskResourcePool.RemoveAt(0);
            DisposeMaskBindGroupResource(resource);
        }
    }
    ...
    private static MaskSamplingUniforms CreateMaskSamplingUniforms(MaskPixelBounds bounds)
    {
        ...
        {
            Coordinate0 = new Vector4(bounds.X, bounds.Y, 0f, 0f),
        ...
        bool hasMask)
    {
        ...
        else if (!BlendModeRequiresPremultipliedSource(blendMode))
        {
            entryPoint = "fs_main";
        }
        else
    ...
    private static string GetSolidRoundedFragmentEntryPoint(
        GpuBlendMode blendMode,
        bool writesOpacityMask,
        bool hasMask)
    {
        string entryPoint = writesOpacityMask
            ? "fs_solid_rounded_mask"
            : BlendModeRequiresPremultipliedSource(blendMode)
                ? "fs_solid_rounded_premultiplied"
                : "fs_solid_rounded_main";
        return hasMask ? entryPoint : $"{entryPoint}_unmasked";
    }

    private static byte GetVectorPipelineKind(in CompositorDrawCall drawCall) =>
        drawCall.IsSolidRounded ? (byte)2 : drawCall.IsSolidRect ? (byte)1 : (byte)0;
        ...
        bool hasMask = true)
    {
        ...
        {
            return (RenderPipeline*)selectedPipeline;
        }
        ...
        fixed (VertexAttribute* attributesPointer = attributes)
        {
            ...
            var pipeline = _pipelineCache.GetOrCreateRenderPipeline(
                pipelineKey,
                shaderModule,
                layouts,
                "vs_solid_rect",
    ...
    private RenderPipeline* GetSolidRoundedPipeline(
        GpuBlendMode blendMode,
        bool isOffscreen,
        TextureFormat? overrideFormat = null,
        bool hasMask = true)
    {
        ...
        {
            var cachedPipeline = isOffscreen
                ? _solidRoundedPipelineOffscreen
                : _solidRoundedPipeline;
            if (cachedPipeline != null)
            {
                return cachedPipeline;
            }
        ...
        fixed (VertexAttribute* attributesPointer = attributes)
        {
            ...
            bool writesOpacityMask = overrideFormat == TextureFormat.R8Unorm;
            string fragmentEntryPoint = GetSolidRoundedFragmentEntryPoint(
                blendMode,
                writesOpacityMask,
                hasMask);
            string targetKey = overrideFormat.HasValue ? $"_{overrideFormat.Value}" : string.Empty;
            string pipelineKey = $"SolidRounded_{(isOffscreen ? "Offscreen_" : string.Empty)}{blendMode}{targetKey}_{fragmentEntryPoint}";
            var pipeline = _pipelineCache.GetOrCreateRenderPipeline(
                pipelineKey,
                shaderModule,
                layouts,
                ...
                !hasMask)
            {
                if (isOffscreen)
                {
                    _solidRoundedPipelineOffscreen = pipeline;
                }
                else
                {
                    _solidRoundedPipeline = pipeline;
                }
            }
            else
            {
    ...
    private RenderPipeline* GetVectorPipeline(
        in CompositorDrawCall drawCall,
        bool isOffscreen,
        TextureFormat? overrideFormat = null,
        bool hasMask = true)
    {
        return GetVectorPipelineKind(drawCall) switch
        {
            2 => GetSolidRoundedPipeline(
                drawCall.BlendMode,
                isOffscreen,
                overrideFormat,
                hasMask),
            1 => GetSolidRectPipeline(
                drawCall.BlendMode,
                isOffscreen,
                overrideFormat,
                hasMask),
        ...
        bool hasMask = true)
    {
        var key = new PipelineSelectionKey(
            ...
            textureAlphaMode,
            hasMask);
        if (_selectedPipelines.TryGetValue(key, out var selectedPipeline))
        {
            return (RenderPipeline*)selectedPipeline;
        }
        ...
        var pipeline = CreatePipeline(
            ...
            textureAlphaMode,
            hasMask);
        _selectedPipelines[key] = (nint)pipeline;
        return pipeline;
    }
        ...
        bool hasMask)
    {
        ...
        {
            if (type == DrawCallType.Text && !hasMask)
            {
                var cachedPipeline = isOffscreen
                    ? _textPipelineOffscreen
                    : _textPipeline;
                if (cachedPipeline != null)
                {
                    return cachedPipeline;
            ...
            if (type == DrawCallType.Vector && !hasMask)
            {
                var cachedPipeline = isOffscreen
                    ? _vectorPipelineOffscreen
                    : _vectorPipeline;
                if (cachedPipeline != null)
                {
                    return cachedPipeline;
        ...
        if (type == DrawCallType.Text)
        {
            ...
            fixed (VertexAttribute* textAttribsPtr = textAttrs)
            {
                ...
                bool writesOpacityMask = overrideFormat == TextureFormat.R8Unorm;
                var textFragmentEntryPoint = GetFragmentEntryPoint(
                    type,
                    blendMode,
                    GpuTextureAlphaMode.Straight,
                    writesOpacityMask,
        ...
        fixed (VertexAttribute* attribsPtr = vectorAttrs)
        {
            ...
            var fragmentEntryPoint = GetFragmentEntryPoint(
                type,
                blendMode,
                textureAlphaMode,
                writesMaskTarget,
    ...
    private void PushGeometryClipValue(PathGeometry geometry, Matrix4x4 transform)
    {
        ...
        RecordGeometryMaskKind(geometry, transform);
        if (TryPushAnalyticCanonicalGeometryMask(geometry, transform))
        {
            _clipScopeIsGeometryMask.Push(true);
            return;
        }
    ...
    private void RecordGeometryMaskKind(
        PathGeometry geometry,
        Matrix4x4 transform)
    {
        ...
        {
            if (HasRoundedCorners(contour))
            {
                _currentFrameRoundedGeometryMaskDemand++;
                _peakRoundedGeometryMaskDemand = Math.Max(
                    _peakRoundedGeometryMaskDemand,
                    _currentFrameRoundedGeometryMaskDemand);
            }
            else
            {
                _currentFrameAffineRectangleMaskDemand++;
                _peakAffineRectangleMaskDemand = Math.Max(
                    _peakAffineRectangleMaskDemand,
                    _currentFrameAffineRectangleMaskDemand);
            }
            float offAxis = MathF.Max(
                MathF.Abs(transform.M12),
                MathF.Abs(transform.M21));
            _minimumCanonicalGeometryMaskOffAxis = MathF.Min(
                _minimumCanonicalGeometryMaskOffAxis,
                offAxis);
            _maximumCanonicalGeometryMaskOffAxis = MathF.Max(
                _maximumCanonicalGeometryMaskOffAxis,
                offAxis);
            if (!IsAxisAlignedClipTransform(transform))
            {
                _currentFrameNonAxisAlignedCanonicalGeometryMaskDemand++;
                _peakNonAxisAlignedCanonicalGeometryMaskDemand = Math.Max(
                    _peakNonAxisAlignedCanonicalGeometryMaskDemand,
                    _currentFrameNonAxisAlignedCanonicalGeometryMaskDemand);
            }
        }
        ...
        {
            _currentFrameGeneralGeometryMaskDemand++;
            _peakGeneralGeometryMaskDemand = Math.Max(
                _peakGeneralGeometryMaskDemand,
                _currentFrameGeneralGeometryMaskDemand);
        }
    }

    private void ResetMaskClassificationFrameMetrics()
    {
        _currentFrameAffineRectangleMaskDemand = 0;
        _currentFrameRoundedGeometryMaskDemand = 0;
        _currentFrameNonAxisAlignedCanonicalGeometryMaskDemand = 0;
        _currentFrameGeneralGeometryMaskDemand = 0;
        _currentFrameOpacityMaskDemand = 0;
        _incrementalPagesBlockedByAnalyticMask = false;
    }

    private static bool HasRoundedCorners(
        RoundedRectanglePathContour contour) =>
        contour.CornerRadiiX != Vector4.Zero &&
        contour.CornerRadiiY != Vector4.Zero;

    private bool TryPushAnalyticCanonicalGeometryMask(
        PathGeometry geometry,
        Matrix4x4 transform)
    {
        // The outermost RenderOffscreen transaction is also the direct
        // presentation path for imported Dawn drawables. Its fragment
        // coordinates and mask layout are equivalent to the primary target,
        ...
        Matrix4x4 normalizedTransform =
            transform == default
                ? Matrix4x4.Identity
                : transform;
        var localToLogical = new Matrix3x2(
            normalizedTransform.M11,
            normalizedTransform.M12,
            normalizedTransform.M21,
            normalizedTransform.M22,
            normalizedTransform.M41,
            normalizedTransform.M42);
        float dpiScale =
            _currentDpiScale > 0f
                ? _currentDpiScale
                : 1f;
        var logicalToPhysical = new Matrix3x2(
            dpiScale,
            0f,
            0f,
            dpiScale,
            CurrentCanvasPixelX,
            CurrentCanvasPixelY);
        Matrix3x2 localToPhysical =
            localToLogical * logicalToPhysical;
        if (!Matrix3x2.Invert(
                localToPhysical,
                out Matrix3x2 physicalToLocal) ||
            !IsFinite(physicalToLocal))
        {
            return false;
        }

        var samplingUniforms = new MaskSamplingUniforms
        {
            Coordinate0 = new Vector4(
                physicalToLocal.M11,
                physicalToLocal.M21,
                physicalToLocal.M31,
                isRectangularHoleRing
        ...
        var logicalBounds = new Rect(
            ...
            contour.Height);
        MaskPixelBounds bounds =
            GetBoundedMaskPixelBounds(
                logicalBounds,
                normalizedTransform);
        _maskStack.Push(
            new MaskTextureState(
                null,
                bounds,
                resource));
        return true;
    ...
    private nint GetActiveMaskBindGroupOverride()
    {
        if (_maskStack.Count == 0)
        {
            return 0;
        ...
        return _maskStack.Peek().AnalyticResource?.BindGroupPtr ?? 0;
    }
    ...
    private void PushOpacityMaskValue(Brush brush, Rect bounds, Matrix4x4 transform)
    {
        ...
        _peakOpacityMaskDemand = Math.Max(
            ...
            _currentFrameOpacityMaskDemand);
        if (TryPushAnalyticSolidOpacityMask(brush, bounds, transform))
        {
            return;
        }
    ...
    private bool TryPushAnalyticSolidOpacityMask(
        Brush brush,
        Rect bounds,
        Matrix4x4 transform)
    {
        if (brush is not SolidColorBrush solid ||
            _offscreenRenderDepth > 1 ||
            _maskStack.Count != 0)
        {
            return false;
        }
        ...
        float alpha = float.IsFinite(sourceAlpha)
            ? Math.Clamp(sourceAlpha, 0f, 1f)
            : 0f;
        var samplingUniforms = new MaskSamplingUniforms
        {
            Coordinate0 = new Vector4(
            ...
            Bounds = new Vector4(
                ...
                bounds.Right,
                bounds.Bottom),
            Options = new Vector4(2f, alpha, 0f, 0f)
        };
        CommitPendingDrawCalls();
        MaskBindGroupResource resource =
            RentAnalyticMaskResource(samplingUniforms);
        _incrementalPagesBlockedByAnalyticMask = true;
        MaskPixelBounds pixelBounds =
            GetBoundedMaskPixelBounds(bounds, normalizedTransform);
        _maskStack.Push(
            new MaskTextureState(
                null,
                pixelBounds,
    ...
    private void PopGeometryMask()
    {
        ...
        if (_maskStack.Count > 0)
        {
            ...
            if (popped.Texture != null)
            {
                _masksToReturnToPool.Add(popped.Texture);
            }
            if (popped.AnalyticResource != null)
            {
                _analyticMasksToReturnToPool.Add(
                    popped.AnalyticResource);
            }
        }
    }
    ...
    private void ExecuteMaskRenderPasses(CommandEncoder* encoder)
    {
        ...
        for (var maskPassIndex = 0; maskPassIndex < maskPassCount; maskPassIndex++)
        {
            ...
            BindGroup* maskBindGroup =
                maskPass.PreviousMaskBindGroupOverride != 0
                    ? (BindGroup*)maskPass.PreviousMaskBindGroupOverride
                    : GetMaskBindGroup(
                        maskPass.PreviousMaskTexture,
                        isOffscreen: true);
    ...
    private void PrepareMaskRenderResourceUploads()
    {
             ...
             maskPassIndex++)
        {
            ...
            EnsureMaskRenderBindGroups(resource, maskPass.DrawCalls);
    ...
    private void EnsureMaskRenderBindGroups(
        MaskRenderResource resource,
        List<CompositorDrawCall> drawCalls)
    {
        ...
        if (needsText && resource.TextUniformBindGroupPtr == 0)
        {
            resource.TextUniformBindGroupPtr =
                CreateMaskRenderSceneStateBindGroup(
                    _textUniformBindGroupLayoutOffscreen,
                    resource);
        }
        if (needsTexture && resource.TextureUniformBindGroupPtr == 0)
        {
            resource.TextureUniformBindGroupPtr =
                CreateMaskRenderUniformBindGroup(
    ...
    private nint CreateMaskRenderSceneStateBindGroup(
        BindGroupLayout* layout,
        MaskRenderResource resource)
    {
        var entries = stackalloc BindGroupEntry[3];
        ...
        {
            throw new InvalidOperationException(
                "Failed to create bounded mask text scene-state bind group.");
        }
