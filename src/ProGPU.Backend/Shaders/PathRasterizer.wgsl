...
// Driver-sensitive translated overlaps rasterize one full 64-sample mask per leaf in phase batches, then evaluate the original postfix program before the single R8 coverage average.
