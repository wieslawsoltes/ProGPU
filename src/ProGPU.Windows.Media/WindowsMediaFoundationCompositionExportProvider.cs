...
/// writer. Registered affine color definitions use a bounded D3D11/Dawn
/// keyed-mutex ring and one fused WebGPU pass. Audio is decoded to PCM and
/// encoded by the native AAC transform. Solid-color clips are generated by
/// WebGPU on the same bounded ring and emit explicit Media Foundation audio
/// gaps.
    ...
    IMediaCompositionExportCapabilityProvider
{
        ...
        MediaEffectRegistry effects)
    {
        ...
        return new MediaCompositionExportCapabilities(
            ...
            Limitation:
                ...
                "folded into one affine color transform and fused into a " +
    ...
    private static MediaCompositionExportFailure
        ...
        IReadOnlyList<GpuTextureColorTransform>
            videoTransforms,
        IProgress<double>? progress,
        CancellationToken cancellationToken)
    {
    ...
    private static bool TryCaptureVideoTransforms(
        MediaCompositionExportRequest request,
        MediaEffectRegistry effects,
        out GpuTextureColorTransform[] transforms)
    {
        transforms =
