...
`src/Skia/Avalonia.Skia` project sources from the prepared Avalonia `12.0.5`
source tree. It exists only to validate the ProGPU `SkiaSharp` API surface
against Avalonia's ordinary Skia backend.

The source tree is prepared by `tools/prepare-avalonia-12.0.5-source.sh` from
the official Avalonia release and is not copied into ProGPU. Avalonia is
licensed under the MIT license:

- <https://github.com/AvaloniaUI/Avalonia/tree/12.0.5>
- <https://github.com/AvaloniaUI/Avalonia/blob/12.0.5/licence.md>
