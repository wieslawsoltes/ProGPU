...
class portable_stroke_style final : public stroke_style {
public:
    portable_stroke_style(
        ...
        : owner_(owner), properties_(properties)
    {
        if (dash_count != 0U) {
        ...
        void** value) noexcept override
    {
        ...
        *value = nullptr;
        if (com::guid_equal(interface_id, com::unknown_interface_id()) ||
            ...
            *value = static_cast<stroke_style*>(this);
            AddRef();
            return com::ok;
        }
...
com::result create_stroke_style(
    factory* owner,
    const stroke_style_properties* properties,
    const float* dashes,
    std::uint32_t dash_count,
    ...
    *value = nullptr;
    ...
    try {
        auto* created = new portable_stroke_style(
            owner, *properties, dashes, dash_count);
        *value = created;
        return com::ok;
