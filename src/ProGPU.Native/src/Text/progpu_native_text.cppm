...
using ::progpu::native::text::text_anchor_width_mode;
...
using ::progpu::native::text::text_floating_item;
using ::progpu::native::text::text_floating_placement;
using ::progpu::native::text::text_floating_flow_result;
using ::progpu::native::text::try_layout_floating_logical_shaped_text_at;
...
using ::progpu::native::text::try_layout_excluded_logical_shaped_text_at;
using ::progpu::native::text::try_build_fragment_text_interaction;
using ::progpu::native::text::try_build_fragment_advance_text_interaction;
...
using ::progpu::native::text::try_get_utf16_grapheme_starts;
...
using ::progpu::native::text::try_get_scaled_text_layout_requirements;
using ::progpu::native::text::text_tab_options;
using ::progpu::native::text::text_tab_glyph_id;
using ::progpu::native::text::try_get_tabbed_text_layout_requirements;
using ::progpu::native::text::try_layout_tabbed_logical_shaped_text;
...
using ::progpu::native::text::try_layout_scaled_logical_shaped_text;
