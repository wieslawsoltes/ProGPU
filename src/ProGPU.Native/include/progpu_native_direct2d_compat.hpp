...
inline constexpr com::guid wic_bitmap_lock_interface_id{
    ...
    0x4877U,
    {0xBAU, 0x0AU, 0xFDU, 0x2BU, 0x66U, 0x45U, 0xFBU, 0x94U}};
inline constexpr com::guid wic_pixel_format_8bpp_alpha{
    0xE6CD0116U,
    0xEEBAU,
    0x4161U,
    {0xAAU, 0x85U, 0x27U, 0xDDU, 0x9FU, 0xB3U, 0xA8U, 0x95U}};
inline constexpr com::guid wic_pixel_format_32bpp_pbgra{
    0x6FDDC324U,
    0x4E03U,
    0x4BFEU,
    {0xB1U, 0x85U, 0x3DU, 0x77U, 0x76U, 0x8DU, 0xC9U, 0x10U}};
inline constexpr com::guid wic_pixel_format_32bpp_bgra{
    0x6FDDC324U,
    0x4E03U,
    0x4BFEU,
    {0xB1U, 0x85U, 0x3DU, 0x77U, 0x76U, 0x8DU, 0xC9U, 0x0FU}};
inline constexpr com::guid wic_pixel_format_32bpp_prgba{
    0x3CC4A650U,
    0xA527U,
    0x4D37U,
    {0xA9U, 0x16U, 0x31U, 0x42U, 0xC7U, 0xEBU, 0xEDU, 0xBAU}};
inline constexpr com::guid wic_pixel_format_32bpp_rgba{
    0xF5C7AD2DU,
    0x6A8DU,
    0x43DDU,
    {0xA7U, 0xA8U, 0xA2U, 0x99U, 0x35U, 0x26U, 0x1AU, 0xE9U}};
