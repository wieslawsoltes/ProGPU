...
bool render_browser_frame(double, void*) {
    ...
    if (progpu_native_engine_update_scene(
        ...
        geometry_scene_metrics.command_count != 2U ||
        geometry_scene_metrics.resource_count != 4U ||
        geometry_scene_metrics.draw_count != 2U) {
    ...
    if (progpu_native_engine_render_scene(
        ...
        geometry_metrics.command_count != 2U ||
        geometry_metrics.draw_call_count != 2U ||
