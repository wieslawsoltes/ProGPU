    ...
    IDisposable
{
    ...
    internal void ReadMetrics(
        ...
        out long topologySynchronizationCount,
        out long adornerSynchronizationCount,
        out long unchangedReuseCount,
        out long layoutClipSynchronizationCount,
        out long geometryClipSynchronizationCount,
        out long bitmapCacheSynchronizationCount,
        out long effectSynchronizationCount,
        out long opacityMaskSynchronizationCount,
        out long inheritedDrawingOptionsSynchronizationCount,
        out long complexAppearanceSynchronizationCount)
    {
        ...
        topologySynchronizationCount = 0;
        adornerSynchronizationCount = 0;
        unchangedReuseCount = 0;
        layoutClipSynchronizationCount = 0;
        geometryClipSynchronizationCount = 0;
        bitmapCacheSynchronizationCount = 0;
        effectSynchronizationCount = 0;
        opacityMaskSynchronizationCount = 0;
        inheritedDrawingOptionsSynchronizationCount = 0;
        complexAppearanceSynchronizationCount = 0;
        ...
        lock (_sync)
        {
            foreach (TargetScene target in _targets.Values)
            {
                ...
                topologySynchronizationCount +=
                    scene.TopologySynchronizationCount;
                adornerSynchronizationCount +=
                    scene.AdornerSynchronizationCount;
                unchangedReuseCount += scene.UnchangedReuseCount;
                layoutClipSynchronizationCount +=
                    scene.LayoutClipSynchronizationCount;
                geometryClipSynchronizationCount +=
                    scene.GeometryClipSynchronizationCount;
                bitmapCacheSynchronizationCount +=
                    scene.BitmapCacheSynchronizationCount;
                effectSynchronizationCount +=
                    scene.EffectSynchronizationCount;
                opacityMaskSynchronizationCount +=
                    scene.OpacityMaskSynchronizationCount;
                ...
                complexAppearanceSynchronizationCount +=
                    scene.ComplexAppearanceSynchronizationCount;
            }
        }
    }
