// Algorithm: Sphere-trace a scene of analytic signed-distance primitives and shade the nearest hit.
// Time complexity: O(M*P) per fragment for M march steps and P evaluated primitives per scene query.
