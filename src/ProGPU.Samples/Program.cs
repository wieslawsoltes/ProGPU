...
public static unsafe class Program
{
    ...
    private static float _fxBlurRadius = 8f;
    private static float _fxShadowRadius = 12f;
    private static Vector2 _fxShadowOffset = new Vector2(5f, 5f);
    private static Vector4 _fxShadowColor = new Vector4(0f, 0f, 0f, 0.6f);
    private static Vector4 _fxNeonColor = new Vector4(0.85f, 0.08f, 0.52f, 0.8f);
    ...
    private static void BuildSceneGraph()
    {
        ...
        var frameworkEffectsItem = new NavigationViewItem("Framework Effects", "✨", CreateFrameworkEffectsView());
    ...
    private static FrameworkElement CreateFrameworkEffectsView()
    {
        var grid = new ProGPU.WinUI.Grid();
        ...
        var title = new RichTextBlock { Font = _font, FontSize = 14f, Margin = new Thickness(0, 0, 0, 5) };
        title.Inlines.Add(new Bold(new Run("Framework UI Effects Pipeline")));
        leftStack.AddChild(title);

        var desc = new RichTextBlock { Font = _font, FontSize = 11f, Margin = new Thickness(0, 0, 0, 15) };
        ...
        blurLabel.Inlines.Add(new Bold(new Run($"Glass Blur Radius: {_fxBlurRadius:F1} px")));
        leftStack.AddChild(blurLabel);

        var blurSlider = new ProGPU.WinUI.Slider { Minimum = 0f, Maximum = 20f, Value = _fxBlurRadius, Width = 260f, Margin = new Thickness(0, 0, 0, 15) };
        leftStack.AddChild(blurSlider);

        // Slider for Shadow Blur Radius
        var shadowBlurLabel = new RichTextBlock { Font = _font, FontSize = 12f, Margin = new Thickness(0, 5, 0, 2) };
        shadowBlurLabel.Inlines.Add(new Bold(new Run($"Shadow Blur: {_fxShadowRadius:F1} px")));
        leftStack.AddChild(shadowBlurLabel);

        var shadowBlurSlider = new ProGPU.WinUI.Slider { Minimum = 0f, Maximum = 30f, Value = _fxShadowRadius, Width = 260f, Margin = new Thickness(0, 0, 0, 15) };
        ...
        offsetXLabel.Inlines.Add(new Bold(new Run($"Shadow Offset X: {_fxShadowOffset.X:F1} px")));
        leftStack.AddChild(offsetXLabel);

        var offsetXSlider = new ProGPU.WinUI.Slider { Minimum = -30f, Maximum = 30f, Value = _fxShadowOffset.X, Width = 260f, Margin = new Thickness(0, 0, 0, 15) };
        leftStack.AddChild(offsetXSlider);

        var offsetYLabel = new RichTextBlock { Font = _font, FontSize = 12f, Margin = new Thickness(0, 5, 0, 2) };
        offsetYLabel.Inlines.Add(new Bold(new Run($"Shadow Offset Y: {_fxShadowOffset.Y:F1} px")));
        leftStack.AddChild(offsetYLabel);

        var offsetYSlider = new ProGPU.WinUI.Slider { Minimum = -30f, Maximum = 30f, Value = _fxShadowOffset.Y, Width = 260f, Margin = new Thickness(0, 0, 0, 15) };
        leftStack.AddChild(offsetYSlider);

        // Neon Glow Presets
        var colorLabel = new RichTextBlock { Font = _font, FontSize = 12f, Margin = new Thickness(0, 5, 0, 8) };
        ...
        var pinkText = new RichTextBlock { Font = _font, FontSize = 10f }; pinkText.Inlines.Add(new Run("Pink")); pinkBtn.Content = pinkText;
        ...
        var cyanText = new RichTextBlock { Font = _font, FontSize = 10f }; cyanText.Inlines.Add(new Run("Cyan")); cyanBtn.Content = cyanText;
        ...
        var greenText = new RichTextBlock { Font = _font, FontSize = 10f }; greenText.Inlines.Add(new Run("Green")); greenBtn.Content = greenText;
        ...
        var shadowCardHeader = new RichTextBlock { Font = _font, FontSize = 15f, Margin = new Thickness(0, 0, 0, 10) };
        shadowCardHeader.Inlines.Add(new Bold(new Run("Classic Drop Shadow")));
        col1Stack.AddChild(shadowCardHeader);

        var shadowCardText = new RichTextBlock { Font = _font, FontSize = 11f, Margin = new Thickness(0, 0, 0, 15) };
        ...
        var shadowCardInput = new TextBox { Font = _font, Text = "Interactive input with shadow", Width = 200f, Height = 32f, Margin = new Thickness(0, 0, 0, 15) };
        ...
        var shadowCardBtnText = new RichTextBlock { Font = _font, FontSize = 11f };
        ...
        var classicShadow = new DropShadowEffect(_fxShadowRadius, _fxShadowOffset, _fxShadowColor);
        ...
        var neonCardHeader = new RichTextBlock { Font = _font, FontSize = 15f, Margin = new Thickness(0, 0, 0, 10) };
        ...
        var neonCardText = new RichTextBlock { Font = _font, FontSize = 11f, Margin = new Thickness(0, 0, 0, 15) };
        ...
        var neonCardInput = new TextBox { Font = _font, Text = "Cyan neon glow focus", Width = 200f, Height = 32f, Margin = new Thickness(0, 0, 0, 15) };
        ...
        var neonCardBtnText = new RichTextBlock { Font = _font, FontSize = 11f };
        ...
        var neonShadow = new DropShadowEffect(_fxShadowRadius + 5f, Vector2.Zero, _fxNeonColor);
        ...
        var blurCardHeader = new RichTextBlock { Font = _font, FontSize = 15f, Margin = new Thickness(0, 0, 0, 10) };
        blurCardHeader.Inlines.Add(new Bold(new Run("Backdrop Glass Blur")));
        col3Stack.AddChild(blurCardHeader);

        var blurCardText = new RichTextBlock { Font = _font, FontSize = 11f, Margin = new Thickness(0, 0, 0, 15) };
        ...
        var blurCardInput = new TextBox { Font = _font, Text = "Blurred input control", Width = 200f, Height = 32f, Margin = new Thickness(0, 0, 0, 15) };
        ...
        var blurCardBtnText = new RichTextBlock { Font = _font, FontSize = 11f };
        ...
        var cardBlur = new BlurEffect(_fxBlurRadius);
        ...
        {
            _fxBlurRadius = blurSlider.Value;
            blurLabel.Inlines.Clear();
            blurLabel.Inlines.Add(new Bold(new Run($"Glass Blur Radius: {_fxBlurRadius:F1} px")));
            blurLabel.Invalidate();
            
            cardBlur.BlurRadius = _fxBlurRadius;
            blurCard.Invalidate();
        };

        shadowBlurSlider.ValueChanged += (s, e) =>
        {
            _fxShadowRadius = shadowBlurSlider.Value;
            shadowBlurLabel.Inlines.Clear();
            shadowBlurLabel.Inlines.Add(new Bold(new Run($"Shadow Blur: {_fxShadowRadius:F1} px")));
            shadowBlurLabel.Invalidate();

            classicShadow.BlurRadius = _fxShadowRadius;
            neonShadow.BlurRadius = _fxShadowRadius + 5f;
        ...
        {
            _fxShadowOffset.X = offsetXSlider.Value;
            offsetXLabel.Inlines.Clear();
            offsetXLabel.Inlines.Add(new Bold(new Run($"Shadow Offset X: {_fxShadowOffset.X:F1} px")));
            offsetXLabel.Invalidate();

            classicShadow.Offset = _fxShadowOffset;
            shadowCard.Invalidate();
        };

        offsetYSlider.ValueChanged += (s, e) =>
        {
            _fxShadowOffset.Y = offsetYSlider.Value;
        ...
        pinkBtn.Click += (s, e) =>
        {
            _fxNeonColor = new Vector4(0.85f, 0.08f, 0.52f, 0.8f);
            neonShadow.Color = _fxNeonColor;
            neonCard.Invalidate();
        };

        cyanBtn.Click += (s, e) =>
        {
            _fxNeonColor = new Vector4(0.0f, 0.75f, 1.0f, 0.8f);
            neonShadow.Color = _fxNeonColor;
            neonCard.Invalidate();
        };
        ...
        greenBtn.Click += (s, e) =>
        {
            _fxNeonColor = new Vector4(0.2f, 0.8f, 0.2f, 0.8f);
            neonShadow.Color = _fxNeonColor;
            neonCard.Invalidate();
        };
