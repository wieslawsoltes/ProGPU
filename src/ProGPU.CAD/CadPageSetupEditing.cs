...
public sealed class CadApplyNamedPageSetupCommand : CadEditCommand
{
    ...
    private PlotSettingsState? _previousState;
    private PlotSettingsState? _appliedState;
    ...
    internal override void Apply(CadDocument document, bool isRedo)
    {
        if (isRedo)
        {
            ...
            PlotSettingsState redoState = _appliedState ??
        ...
        PlotSettingsState previous = PlotSettingsState.Capture(layout);
        PlotSettingsState appliedState = PlotSettingsState.Capture(namedPageSetup)
    ...
    internal override void Revert(CadDocument document)
    {
        ...
        PlotSettingsState previous = _previousState ??
            throw new InvalidOperationException(
                "The page-setup command has not been applied.");
    ...
    private static void ApplyTransactional(
        PlotSettings target,
        PlotSettingsState desired)
    {
        PlotSettingsState rollback = PlotSettingsState.Capture(target);
        try
        {
    ...
    private readonly record struct PlotSettingsState(
    ...
    {
        public static PlotSettingsState Capture(PlotSettings source) => new(
        ...
        public PlotSettingsState WithModelType(bool modelType) => this with
        {
            Flags = modelType
