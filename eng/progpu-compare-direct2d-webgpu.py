...
PROBES = ((2, 2), (10, 10), (40, 14), (18, 28), (46, 36))
EXPECTED_SIZE = (64, 48)
...
def compare(reference_path: pathlib.Path, candidate_path: pathlib.Path) -> dict:
    ...
    # The five solid/interior probes must remain within one channel level.
...
def main() -> int:
    ...
    contract = {
        ...
        "Fixture": "64x48 clear, rectangle, ellipse, stroked rectangle, rounded rectangle",
        "Tolerance": {
