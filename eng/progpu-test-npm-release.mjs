...
const manifest = {name: 'progpu', version: '0.1.0-preview.1', type: 'module', main: './index.js', types: './index.d.ts',
...
async function fixture(directory, options = {}) {
  ...
  const metadata = {schemaVersion: 1, name: 'progpu', version: manifest.version,
    archive: `progpu-${manifest.version}.tgz`, sha256: hash(bytes),
