...
export async function verifyInstalledNpmTypes(consumerDirectory, packageName = 'progpu-renderer') {
...
// @ts-expect-error The package does not install the original unpublished name as an alias.
await import('progpu');
// @ts-expect-error The superseded personal-scope proposal is not a compatibility alias.
await import('@wieslawsoltes/progpu');
