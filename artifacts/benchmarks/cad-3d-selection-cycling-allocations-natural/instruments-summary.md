...
Generated: 2026-08-31T23:38:43.0758920+00:00
...
| --- | ---: | ---: | ---: |
| Heap and anonymous VM | 20,759,088 B | 70,010,656 B | 49,251,568 B |
| Heap allocations | 9,617,968 B | — | — |
| Anonymous VM | 11,141,120 B | — | — |
| All VM regions | 318,259,200 B | — | — |

### Largest persistent native/VM categories

| Category | Persistent | Count | Total allocated |
| --- | ---: | ---: | ---: |
| VM: Memory Tag 255 | 188,907,520 B | 10 | 4,287,610,880 B |
| VM: Mapped File | 93,044,736 B | 83 | 116,523,008 B |
...
| Malloc 32 Bytes | 224,096 B | 7,003 | 516,576 B |
| Malloc 176,00 KiB | 180,224 B | 1 | 180,224 B |
| Malloc 64 Bytes | 171,392 B | 2,678 | 668,096 B |
| Malloc 144,00 KiB | 147,456 B | 1 | 147,456 B |
| Malloc 24,00 KiB | 98,304 B | 4 | 393,216 B |
| Malloc 1,50 KiB | 84,480 B | 55 | 754,176 B |
| Malloc 16,00 KiB | 81,920 B | 5 | 884,736 B |
| Malloc 14,00 KiB | 71,680 B | 5 | 630,784 B |
| Malloc 3,00 KiB | 67,584 B | 22 | 3,732,480 B |
| Malloc 224 Bytes | 67,200 B | 300 | 245,280 B |
| Malloc 192 Bytes | 48,192 B | 251 | 778,368 B |
| Malloc 5,00 KiB | 40,960 B | 8 | 501,760 B |
| Malloc 7,00 KiB | 35,840 B | 5 | 114,688 B |
| Malloc 48 Bytes | 34,224 B | 713 | 243,264 B |
| Malloc 16 Bytes | 28,976 B | 1,811 | 54,432 B |
