...
echo "Avalonia retained pixel contract passed: 9 zero-fallback pages, native linear/conic/picture opacity masks, transformed adorner clip chains, blur/drop-shadow effects, geometry clipping, inherited text options, and BitmapCache scale/snap/ClearType."
