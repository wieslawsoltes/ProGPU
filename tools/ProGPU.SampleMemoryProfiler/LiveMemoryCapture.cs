...
internal static partial class LiveMemoryCapture
{
    ...
    private static async Task<int> RunAsync(CaptureOptions options)
    {
        ...
        var counters = new RuntimeCounterCollector(options.ProcessId, options.Interval);
        Task counterTask = counters.StartAsync();
        ...
        JsonObject root = new()
        {
            ...
            ["runtimeEventDiagnostics"] = counters.Diagnostics(),
